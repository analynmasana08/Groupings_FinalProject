...
if (isset($_POST['id'])) 
{
	...
	$sql = "UPDATE package_menus SET id='$id',menu_package='$menu',price_per_head='$price' WHERE id='$id'";
...
if (isset($_GET['id'])) {
	$id=$_GET['id'];
	$sql="SELECT * FROM package_menus WHERE id=$id";
